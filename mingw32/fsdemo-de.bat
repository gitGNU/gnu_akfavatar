...
#.datadir /home/akf/Bilder
# datadir - wo sich die Medien-Dateien befinden
# Kann auch über die Umgebungsvariable AVATARDATADIR gesetzt werden

#.avatarimage human-peasant.bmp
# avatarimage - welches Bild als Avatar verwendet wwerden soll 
# muss vor dem auszugebenden Text angegeben werden!
# Kann auch über die Umgebungsvariable AVATARIMAGE gesetzt werden
# (mit vollständiger Pfadangabe)

Bei dem Begriff „Freie Software“ geht es um Freiheit, nicht um den Preis.
Um dieses Konzept richtig begreifen zu können, sollte man an „frei“ wie in
„freie Rede“ denken...\
.effectpause
.back 3
, und nicht an „Freibier“.
