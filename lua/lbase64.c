...
* modified by Andreas K. Foerster <akf@akfoerster.de>
* December 2011
...
static void
encode (luaL_Buffer * b, uint c1, uint c2, uint c3, int n)
{
...
static void
decode (luaL_Buffer * b, int c1, int c2, int c3, int c4, int n)
{
